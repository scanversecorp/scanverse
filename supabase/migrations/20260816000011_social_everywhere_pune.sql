...
UPDATE scanv_social_config SET app_link = 'https://getscanv.com?utm_source=social&utm_medium=coming_soon_pune', updated_at = NOW() WHERE id = 'default';
...
https://getscanv.com?utm_source=social&utm_medium=coming_soon_pune', updated_at = NOW()
WHERE id = 'w1-d1-launch-post';

UPDATE scanv_social_content SET caption = '🚀 Coming soon everywhere in Pune — ekach app. Your mess. Our problem. 😉 getscanv.com', updated_at = NOW()
...
https://getscanv.com/#vendor-onboard?utm_source=social&utm_medium=coming_soon_partner', updated_at = NOW()
