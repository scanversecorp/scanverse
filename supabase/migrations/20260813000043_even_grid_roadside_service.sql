-- tw-towing and fw-maintenance: even roadside/service theme grids + pricing sync
...
INSERT INTO service_pricing (
  ...
  ('tw-towing', 'Two Wheeler', 'Roadside', 'Two Wheeler Support', 'Emergency Towing', 34900, 26175, 18323, 70, 7852, 30),
  ('fw-maintenance', 'Four Wheeler', 'Service', 'Four Wheeler Support', 'Periodic Car Service', 59900, 44925, 31448, 70, 13477, 30)
...
WHERE service_id IN ('tw-towing', 'fw-maintenance')
ON CONFLICT (service_id) DO UPDATE SET
...
UPDATE service_pricing SET
  sub_service_name = 'Mechanic · pick-up · wash · 8 services'
WHERE service_id = 'two-wheeler';

UPDATE service_pricing SET
  sub_service_name = 'Car service · pick-up · sanitization · 8 services'
...
WHERE sp.service_id IN ('tw-towing', 'fw-maintenance')
