...
export const GO_LIVE_MANUAL_CHECKS: ManualCheckDef[] = [
  ...
  { key: "go_live_check_upi_vpa_live", category: "B. UPI · HDFC Vyapar", functions: "UPI VPA", description: "Vyapar.172928067841@hdfcbank activated for incoming payments", required: true },
  ...
  { key: "go_live_check_razorpay_webhook_events", category: "C. Razorpay backup", functions: "razorpay-payment", description: "Webhook events enabled: payment.captured, payment_link.paid", required: true },
...
export async function buildGoLiveConfig(sb: PlatformSb): Promise<Record<string, unknown>> {
  ...
  const references = [
    ...
    },
    {
      ...
      value: "Vyapar.172928067841@hdfcbank",
      toggleable: false,
    },
    {
      type: "reference",
