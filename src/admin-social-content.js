  ...
  return (
    <div style={{ ...S.card(), padding: 16, marginBottom: 14, border: `2px solid ${progress?.complete ? C.green : C.gold}` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap', marginBottom: 10 }}>
        <div>
          <div style={{ fontWeight: 800, color: C.txt, fontSize: 15 }}>One App for everything · Local community · Local support · Global happiness</div>
  ...
  return (
    <div>
      <div style={{ ...S.card(), padding: 16, marginBottom: 14, border: `1.5px solid ${C.acc}44` }}>
        <div style={{ fontWeight: 800, color: C.txt, marginBottom: 6 }}>Social dashboard — @{cfg.handle || 'scanvapp'} · One App for everything</div>
